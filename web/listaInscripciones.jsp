<%-- 
    ...
    Created on : 07-nov-2019, 0:55:34
    Author     : Dell
--%>
...
<br><br><br>
        <form method="POST" action="/centroMedicinalDeDeporte/servletListaInscripcion" onsubmit="return validar();">

                                            <table border="1" align="center" class="table table-striped">
                                        <tr><th> N° </th><th>Fecha</th><th>N° Orden</th><th>Paciente</th><th>Disciplina</th><tr>
					<c:forEach items="${listaInscripciones}" var="i">
                                            <tr>   
                                                <td> ${i.getIdInscripcion()}</td>
                                                <td> ${i.getFecha()} </td>
                                                <td> ${i.getOrdenMedica().getIdOrdenMedica()}  </td>
                                                <td> ${i.getOrdenMedica().getPaciente().toString()} </td>
                                                
                                                <td> ${i.getOrdenMedica().getDisciplina().getDisciplina()} </td>
