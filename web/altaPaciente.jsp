<%-- 
    ...
    Created on : 30-oct-2019, 12:07:58
    Author     : Dell
--%>
...
<br><br><br>
        ...
        <form style="margin-left: 15px" method="POST" action="/centroMedicinalDeDeporte/servletAltaPaciente" onsubmit="return validar();">
            
            
            <input type="text" name="txtId" hidden="" value="${idPaciente}"/>
