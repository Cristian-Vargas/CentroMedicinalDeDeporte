<%-- 
    Document   : reporte1
    Created on : 08-nov-2019, 2:27:02
    Author     : Dell
--%>
...
<div class="spinner-grow text-primary" role="status">
	...
	<body>				
                                        ...
                                        <tr><th> Paciente </th><th>DNI</th><th>Telefono</th><th>Email</th><th>Direccion</th><th>Sexo</th><th>Disciplina</th><tr>
					<c:forEach items="${listaReporte1}" var="a">
                                            <tr>   
                                                <td> ${a.getPaciente().toString()} </td>
                                                <td> ${a.getPaciente().getDni()} </td>
                                                <td> ${a.getPaciente().getTelefono()} </td>
                                                <td> ${a.getPaciente().getEmail()}  </td>
                                                <td> ${a.getPaciente().getDomicilio()} </td>
                                                <td> ${a.getPaciente().getSexo()} </td>
                                                <td> ${a.getDisciplina().getDisciplina()} </td>                                              
                                                </tr> 
					</c:forEach>
