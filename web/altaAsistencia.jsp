<%-- 
    ...
    Created on : 08-nov-2019, 4:22:07
    Author     : Dell
--%>
...
<br><br><br>
        ...
        <form style="margin-left: 15px" method="GET" action="/centroMedicinalDeDeporte/index.jsp" onsubmit="return validar();">
           
            
            <div class="alert alert-danger" role="alert">
            Pagina en construccion <a href="/centroMedicinalDeDeporte/index.jsp" class="alert-link">Gracias, Vuelva Prontos</a>.
            </div>
            <div>
            <img src="imagenes/Apu-4.jpg" alt=""/>
            </div>
        </form>
