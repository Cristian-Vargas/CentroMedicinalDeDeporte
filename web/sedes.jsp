<%-- 
    Document   : sedes
    Created on : 07-nov-2019, 12:20:59
    Author     : Dell
--%>
...
<div class="spinner-grow text-primary" role="status">
      ...
      <br><br><br>
        <form method="POST" action="/centroMedicinalDeDeporte/servletListaSedes" onsubmit="return validar();">
            
				<ul>
                                  <table border="1"> 
                                      <tr>
                                    <td><img src="imagenes/c1.jpg" alt="" align="center"/> </td>
                                  <td>  <img src="imagenes/c2.jpg" alt="" align="center"/></td>
                                  <td>  <img src="imagenes/c3.jpg" alt="" align="center"/> </td></tr>  
					
                                       <tr>  <c:forEach items="${listaSede}" var="a">
						<td> <br><h1>${a.getNombre()} </h1> <p>Direccion: ${a.getDireccion()} </p> <p>Telefono: ${a.getTelefono()} </p> </td>
					</c:forEach>
                                       </tr>     
                                  </table>             
				</ul>
