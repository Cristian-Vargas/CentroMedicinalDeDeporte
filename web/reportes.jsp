<%-- 
    Document   : reportes
    Created on : 08-nov-2019, 2:07:37
    Author     : Dell
--%>
...
<div class="spinner-grow text-primary" role="status">
      ...
      <br><br><br>
        ...
        <form style="margin-left: 15px" method="GET" action="/centroMedicinalDeDeporte/servletReporte1" onsubmit="return validar();">
            <table>
            <tr>
                <p4>Listado de todos los pacientes de una disciplina:</p4> </tr>
                
                 <tr>   <select name="listaDisciplina">
                ...
                <tr> 
                    <button type="submit" class="btn btn-info btn-lg">Reporte</button>
                </tr>
              </table>                  
        </form>
      ...
      <form style="margin-left: 15px" method="GET" action="/centroMedicinalDeDeporte/servletReporte2" onsubmit="return validar();">
            <table>
            <tr>
                <p4>Listado para honorarios de los profesionales: debe mostrar por cada
                profesional la cantidad total de inscripciones ordenadas.</p4> </tr>
