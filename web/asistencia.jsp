<%-- 
    Document   : asistencia
    Created on : 31-oct-2019, 12:34:55
    Author     : Dell
--%>
...
<br><br><br>
        ...
        <form style="margin-left: 15px" method="GET" action="/centroMedicinalDeDeporte/servletAltaAsistencia" onsubmit="return validar();">
            
            <div class="form-group row">
                <label for="inputNroInscripcion" class="col-sm-1 col-form-label">Nro. Inscripcion</label>
                    <div class="col-sm-2">            
                        <input class="form-control" id="inputNroInscripcion" placeholder="NroInscripcion" type="text" name="txtNroInscripcion" value="">
