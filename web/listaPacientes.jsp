<%-- 
    ...
    Created on : 06-nov-2019, 2:17:51
    Author     : Dell
--%>
...
<br><br><br>
        ...
        <form method="POST" action="/centroMedicinalDeDeporte/servletListaPaciente" onsubmit="return validar();">

				
                                    <table border="1" align="center " class="table table-striped">
                                        <tr><th> N° </th><th>Paciente</th><th>DNI</th><th>Sexo</th><th>Telefono</th><th>Direccion</th><th>Email</th><th></th><th></th><th></th> <tr>
					<c:forEach items="${listaPaciente}" var="a">
                                            <tr>   
                                                ...
                                                <td> ${a.getEmail()}  </td>
                                                <td> <a  href="/centroMedicinalDeDeporte/servletAltaPaciente?idPaciente=${a.idPaciente}">modificar</a>  </td>
                                                <td> <a  href="/centroMedicinalDeDeporte/servletEliminarPaciente?idPaciente=${a.idPaciente}">eliminar</a>  </td>
                                                <td> <a  href="/centroMedicinalDeDeporte/servletOrdenMedica?idPaciente=${a.idPaciente}">Nueva Orden Medica</a>  </td>
