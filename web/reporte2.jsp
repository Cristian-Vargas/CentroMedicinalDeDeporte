<%-- 
    Document   : reporte2
    Created on : 08-nov-2019, 3:42:11
    Author     : Dell
--%>
...
<div class="spinner-grow text-primary" role="status">
    ...
    <body>
                                    ...
                                    <table border="1" align="center" class="table table-striped">
                                        <tr><th> Legajo </th><th>Medico</th><th>Ordenes Emitidas</th><tr>
					<c:forEach items="${listaReporte2}" var="a">
                                            <tr>   
                                                <td> ${a.getProfesional().getLegajo()} </td>
                                                <td> ${a.getProfesional().getNombre()} </td>
                                                <td> ${a.getCantidadSesiones()} </td>                                           
                                                </tr> 
					</c:forEach>
